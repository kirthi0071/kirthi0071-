...
- Infrastructure as Code projects using Terraform across multi-cloud environments
- GitOps CI/CD pipelines (ArgoCD, Jenkins, GitHub Actions) for Kubernetes deployments
- Cloud migration and disaster recovery architectures
- Monitoring & observability tooling (Prometheus, Grafana, ELK)
